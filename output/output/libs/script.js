...
$(document).ready(function () {
    var service = {
        ...
        gradeName: null,
        dataUrl: null,
        getLinkParam: function getLinkParam(name) {
        ...
        getUserInfo: function getUserInfo(phone, uuID, pd, encryptInfo, callback) {
    ...
    try {
        var ad = service.getLinkParam("ad") ? Base64.decode(service.getLinkParam("ad")) : "";
        var pn = service.getLinkParam("pn") ? Base64.decode(service.getLinkParam("pn")) : "";
        var address = service.getLinkParam("ad") || "";
        var phone = service.getLinkParam("pn") || "";
        var uuID = service.getLinkParam("bs") || "";
        var pd = service.getLinkParam("pd") || "";
        var encryptInfo = md5(Base64.decode(address) + "eebbk" + Base64.decode(phone) + Base64.decode(uuID)).toUpperCase();
